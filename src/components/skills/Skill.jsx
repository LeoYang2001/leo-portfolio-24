...
const skillSets = [
  {
    skillTitle: "Frontend",
    skillList: ["Javascript", "React", "Jquery", "Vue", "NextJS", "LeafletJS"],
  },
  {
    skillTitle: "Backend",
    skillList: ["AWS", "NodeJS", "C#", "Firebase"],
  },
  {
    skillTitle: "Database",
    skillList: ["DynamoDB", "Firestore", "MongoDB", "Mysql", "PL/SQL"],
  },
  {
    skillTitle: "Mobile Development",
    skillList: ["React Native", "Swift"],
  },
  {
    skillTitle: "Data Science",
    skillList: ["R Language", "Matlab"],
  },
  {
...
const Skill = () => {
  ...
  return (
    ...
    >
      ...
      <span className="section__subtitle">My technique stack</span>
