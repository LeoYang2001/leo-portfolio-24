  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        Passionate international student from China. Initially a Mechanical
        Engineering major, my pivotal moment came with the development of my
        skills in coding. This led me to relocate to the U.S. and pursue a
        career in Computer Science.
      </p>
      <a
        download="leoYang-2025-resume.pdf" // You can provide any desired file name here
        href="https://firebasestorage.googleapis.com/v0/b/myportfolio-5f48d.firebasestorage.app/o/leoYang-2025-resume.pdf?alt=media&token=a3cd2e71-3cab-4af8-a709-2844dcdc290f"
